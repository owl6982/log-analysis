...
def read_content(content_file, text):
	...
	print("creating the file: %s ..." % str("log_record_ubuntu.csv"))
	with open("result/log_record_ubuntu.csv", "w", encoding="utf-8") as f:
	...
	print("create the file: %s complete" % str("log_record_ubuntu.csv"))

	print("reading the file: %s ..." % str("log_result_ubuntu.csv"))
	with open("result/log_record_ubuntu.csv", "r", encoding="utf-8") as f:
		f.readline()
	...
	with open("result/log_result_ubuntu.csv", "w", encoding="utf-8") as f:
	...
	print("read the file: %s complete" % str("log_result_ubuntu.csv"))

	print("creating the visual file: %s ..." % str("visual_of_ubuntu.html"))
	...
	with open('web/index ubuntu.txt', 'r', encoding='utf-8') as f:
		z = f.read().format(y,y2)

	with open('result/visual_of_ubuntu.html', 'w', encoding='utf-8') as f:
		f.write(z)



	with open(r'result/log_record_ubuntu.csv','r',encoding='utf-8') as f:
		for line in f:
			content = line.split(',')
			for i in content:
